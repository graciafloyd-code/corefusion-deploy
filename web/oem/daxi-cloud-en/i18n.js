(function () {
  ...
  const translations = {
    ...
    'DAXI CLOUD BRANDED PLATFORM': 'DAXI CLOUD 品牌化平台',
    'Launch Your': '上线你的',
    'Branded AI Cloud Platform': '品牌化 AI 云平台',
    'Model APIs, token billing, reseller management, and industry AI solutions in one branded cloud portal.': '模型 API、Token 计费、经销商客户管理和行业 AI 应用，集中在一个品牌化云平台里。',
    ...
    'Start Your Partner Integration': '开始你的合作伙伴接入',
    ...
    'Expert Support': '专家支持',
    'Dedicated success team for your growth.': '专属成功团队支持业务增长。',
  ...
  const titleTranslations = {
    ...
    'Start Partner Integration | DAXI Cloud': '开始合作伙伴接入 | DAXI Cloud',
